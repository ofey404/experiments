...
class SetResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["updated", "old_value"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.old_value:
            _dict['old_value'] = self.old_value.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "old_value": OldValue.from_dict(obj["old_value"]) if obj.get("old_value") is not None else None
        })
        return _obj
