...
details = {"name": "http://{0}{1}:9080".format(detailsHostname, servicesDomain), "endpoint": "details", "children": []}

ratings = {"name": "http://{0}{1}:9080".format(ratingsHostname, servicesDomain), "endpoint": "ratings", "children": []}
...
tracer = Tracer(one_span_per_rpc=True,
    ...
    def decorator(f):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                span = tracer.start_span(operation_name='op', child_of=span_ctx, tags=rpc_tag)
