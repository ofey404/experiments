...
class ApplianceTest(unittest.TestCase):
    ...
    def test_header_propagation_reviews(self, m):
        ...
        m.get("http://reviews:9080/reviews/%d" % product_id, text='{}', request_headers=expected_headers)
    ...
    def test_header_propagation_ratings(self, m):
        ...
        m.get("http://ratings:9080/ratings/%d" % product_id, text='{}', request_headers=expected_headers)
