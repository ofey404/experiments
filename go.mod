module github.com/ofey404/experiments
...
require (
	...
	go.temporal.io/sdk/contrib/tools/workflowcheck v0.0.0-20230607210332-24f2c86f0229
...
require (
	...
	github.com/grafana/grafana-api-golang-client v0.26.0 // indirect
