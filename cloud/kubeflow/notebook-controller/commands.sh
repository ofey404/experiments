...
cd go-client
    ...
    go test . -v
    # resource = {"metadata":{"name":"name","creationTimestamp":null,"labels":{"app":"notebook","name":"label name"}},"spec":{"template":{"spec":{"containers":[{"name":"notebook","image":"kubeflownotebookswg/jupyter:v1.6.0-rc.0","resources":{}}]}}},"status":{"conditions":null,"readyReplicas":0,"containerState":{}}}
cd -